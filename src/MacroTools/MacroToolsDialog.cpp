// MacroToolsDialog.cpp : implementation file
...
BOOL playing_back;
CMacroToolsDialog * dialog_ptr;

BOOL recording;

char signature[]="XINGYUN";
...
CMacroToolsDialog::CMacroToolsDialog(CWnd* pParent /*=NULL*/)
	: CDialog(CMacroToolsDialog::IDD, pParent)
{
...
void CMacroToolsDialog::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMacroToolsDialog)
	DDX_Control(pDX, IDC_BUTTON_OPTIONS, m_options_button);
	DDX_Control(pDX, IDC_BUTTON_BROWSE, m_browse_button);
	DDX_Control(pDX, IDC_EDIT_FILENAME, m_filename);
	DDX_Control(pDX, IDC_BUTTON_PLAYBACK, m_playback_button);
	DDX_Control(pDX, IDC_BUTTON_RECORD, m_record_button);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CMacroToolsDialog, CDialog)
	//{{AFX_MSG_MAP(CMacroToolsDialog)
	ON_BN_CLICKED(IDC_BUTTON_RECORD, OnRecord_Click)
	ON_BN_CLICKED(IDC_BUTTON_PLAYBACK, OnPlayback_Click)
	ON_BN_CLICKED(IDC_BUTTON_BROWSE, OnBrowse_Click)
	ON_BN_CLICKED(IDC_BUTTON_ABOUT, OnAbout_Click)
	ON_BN_CLICKED(IDC_BUTTON_OPTIONS, OnOptions_Click)
	//}}AFX_MSG_MAP
	
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMacroToolsDialog message handlers

BOOL CMacroToolsDialog::OnInitDialog()
{
...
void CMacroToolsDialog::OnRecord_Click()
{
...
void CMacroToolsDialog::ShowFileDialog (CEdit *textbox)
{
	/**************************
...
BOOL CMacroToolsDialog::CheckFileName(CEdit *filename_field,fstream *stream, int mode,CString error_mesg)
{
	/*************************
...
void CMacroToolsDialog::OnPlayback_Click()
{
...
void CMacroToolsDialog::StartPlayback()
{
...
void CMacroToolsDialog::StopRecording()
{
...
void CMacroToolsDialog::OnBrowse_Click()
{
		ShowFileDialog(&m_filename);	
}

void CMacroToolsDialog::FinishedPlayback()
{
	statusbar.SetText("Ready to Record",0,0);
...
void CMacroToolsDialog::OnAbout_Click()
{
...
void CMacroToolsDialog::OnOptions_Click()
{
